...
static void writeTo(int8 address, int8 val);
static void readFrom(int8 address, int16 num, uint8 buff[]);
static void setRegisterBit(int8 regAdress, int16 bitPos, bool state);
static bool getRegisterBit(int8 regAdress, int16 bitPos);
